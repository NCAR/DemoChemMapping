...
module chemical_mechanism_qx5
  ...
  public :: chemical_mechanism_qx5_t

  !> The QX5 chemical mechanism
  type, extends(chemical_mechanism_t) :: chemical_mechanism_qx5_t
  contains
    ...
    procedure :: solve
  end type chemical_mechanism_qx5_t

  !> QX5 mechanism constructor
  interface chemical_mechanism_qx5_t
    procedure :: constructor
  end interface chemical_mechanism_qx5_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function num_gas_species( this )
    ...
    !> Chemical mechanism
    class(chemical_mechanism_qx5_t), intent(in) :: this
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function constructor( config_file_name ) result( new_mech )
    ...
    !> New mechanism
    type(chemical_mechanism_qx5_t), pointer :: new_mech
    ...
    write(*,*) "Creating QX5 chemical mechanism"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function reaction_name_id_pairs( this ) result( pairs )
    ...
    pairs( 3 )%name = "BIGALK_1"
    pairs( 3 )%id   = 3

    pairs( 4 )%name = "BIGALK_2"
    pairs( 4 )%id   = 4
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine solve( this,                                                     &
    ...
    write(*,*) "Solving QX5 mechanism with photolysis and emissions rates "// &
