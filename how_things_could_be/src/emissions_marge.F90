...
module emissions_marge
  ...
  public :: emissions_marge_t

  !> MARGE emissions module
  type, extends(emissions_t) :: emissions_marge_t
  contains
    !> Species name-id pairs
    procedure :: species_name_id_pairs
    !> Calculate the emissions rates
    procedure :: get_rates
  end type emissions_marge_t

  !> MARGE emissions module constructor
  interface emissions_marge_t
    procedure :: constructor
  end interface emissions_marge_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function constructor( config_file_name ) result( new_mod )
    ...
    !> New MARGE emissions module
    type(emissions_marge_t), pointer :: new_mod
    ...
    write(*,*) "Creating the MARGE emissions module"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function species_name_id_pairs( this ) result( pairs )
    ...
    !> Emissions module
    class(emissions_marge_t), intent(in) :: this
    ...
    pairs( 2 )%name = "ISOPRENE"
    pairs( 2 )%id   = 2

    pairs( 3 )%name = "MONOTERPENE"
    pairs( 3 )%id   = 3
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine get_rates( this, emission_rates__num_m3_s, map )
    ...
    write(*,*) "Running the MARGE emissions module and mapping from "//      &
